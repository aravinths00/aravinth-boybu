...
class DiscussionAddedBlueprint implements BlueprintInterface, MailableInterface
{
    ...
    {
        return 'boybuPrivateDiscussionAdded';
    }
    ...
    {
        return ['text' => 'aravinth\boybu::emails.privateDiscussionAdded'];
    }
    ...
    {
        return $translator->trans('aravinth-boybu.email.subject.private_discussion_added', [
