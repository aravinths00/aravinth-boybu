...
class DiscussionCreatedBlueprint implements BlueprintInterface, MailableInterface
{
    ...
    {
        return 'boybuPrivateDiscussionCreated';
    }
    ...
    {
        return ['text' => 'aravinth-boybu::emails.privateDiscussionCreated'];
    }
    ...
    {
        return $translator->trans('aravinth-boybu.email.subject.private_discussion_created', [
