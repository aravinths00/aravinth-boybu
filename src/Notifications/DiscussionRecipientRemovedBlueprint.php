...
class DiscussionRecipientRemovedBlueprint implements BlueprintInterface, MailableInterface
{
    ...
    {
        return ['text' => 'aravinth-boybu::emails.boybuRecipientRemoved'];
    }
    ...
    {
        return $translator->trans('aravinth-boybu.email.subject.recipient_removed', [
