...
namespace Aravinth\Boybu\Notifications;
...
class DiscussionRepliedBlueprint implements BlueprintInterface, MailableInterface
{
    ...
    {
        return 'boybuPrivateDiscussionReplied';
    }
    ...
    {
        return ['text' => 'aravinth-boybu::emails.privateDiscussionReplied'];
    }
    ...
    {
        return $translator->trans('aravinth-boybu.email.subject.private_discussion_replied', [
